...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestPermission(Manifest.permission.ACCESS_FINE_LOCATION, this.ACCESS_FINE_LOCATION);
        requestPermission(Manifest.permission.ACCESS_COARSE_LOCATION, this.ACCESS_COARSE_LOCATION);
    }
